...
<body>
    ...
    <div class="container">
        ...
        <hr>
        <form action="./db/createContact.php" method="post" id="createForm" onsubmit=" return validateForm()">
            <div class="row">

                <div class="col">
                    <div class="form-group">
                        <label for="id">ID</label>
                        <input type="text" name="id" id="id" disabled placeholder="auto" class="form-control">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="title" id="title" placeholder="Employee" class="form-control">
                    </div>
                </div>
                <div class="col">
                    ...
                    <div class="form-group">
                        ...
                        <input type="tel" name="phone" id="phone" placeholder="02145896302" class="form-control">
                    </div>
                    <div class="form-group">
                        <label for="created">Created</label><span class="alert-danger ml-2 ml-2" id="error-created"></span>
                        <input type="text" name="created" id="created" placeholder="" class="form-control"  value="<?=date('d/m/Y H:m')?>" disabled>
                    </div>
                </div>

            </div>
            <input class="btn mt-3" id="btn-create-user" type="submit" name="submit" value="Create"/>
        </form>
